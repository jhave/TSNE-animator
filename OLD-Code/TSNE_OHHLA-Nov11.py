...
READ_PATH = "Data/testing/"   #"Data/ohhla_CLEAN_txt_files_ALL/"
...
for _ in itertools.repeat(None, N):
    ...
    fig.savefig("img/"+save_PATH+"/"+str(iters)+"_TSNE.png", transparent=False)
    ...
    #plt.show()
    fig.savefig("img/"+save_PATH+"/"+str(iters)+"ANNOTATED_TSNE.png", transparent=False)
