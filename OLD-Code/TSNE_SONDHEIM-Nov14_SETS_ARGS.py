...
parser.add_argument('--e_gate_limit', type=int, default=2000)
...
for _ in itertools.repeat(None, N):
	...
	plt.title('LYS: %s | LR: %s \nC: %s | P: %s | E: %s'%(n_comp,lr, n_comp_init,perp,exag), loc='left')
	...
	txt_fn = "LR{}_EXAG{}_C{}_LAYERS{}_P{}.txt".format(lr,exag,n_comp_init,n_comp,perp)
