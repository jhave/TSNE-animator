...
READ_PATH = "/mnt/bytenet_data/www.alansondheim.org/" 
#"Data/s_test/"  #"www.alansondheim.org/"
...
for _ in itertools.repeat(None, N):
	...
	fig.savefig("img/"+save_PATH+"/"+str(iters)+"_TSNE_SONDHEIM.png", transparent=True, figsize=(16.0, 9.0), dpi=320)
